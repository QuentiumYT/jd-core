...
public class JavaOperatorPrecedenceTest extends TestCase {
    ...
    static class NewOperatorPrecedence {
        void test() {}
    ...
    public void testNewOperatorPrecedence() throws Exception {
        ...
        assertTrue(source.matches(PatternMaker.make(": 42 */", "new NewOperatorPrecedence().test();")));
